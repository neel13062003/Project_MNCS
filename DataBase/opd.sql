...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2022 at 03:37 PM
...
(21, 55, 'neelnsoni13@gmail.com', 7894561230, 0, 'hello\r\n', '2022-12-25 00:25:17');
...
(25, 132, 'Chagan', 7894561230, 1, '2022-12-25 00:20:27');
...
(132, 'Kalp Soni', 54, 'bayad123', 78945612, 'Bayad, ', 0, 7874866543, 2999, '0', '0', '1', '2', '2022-12-24 23:57:15');
...
(20, 130, 1000, '2022-12-24 23:46:11'),
(21, 132, 2500, '2022-12-25 00:19:04');
...
(54, 'kalpsoni10', 'Kalp', 'Soni', 78945612, 'bayad123', 'kalpsoni@gmail.com', '59/Shreejicharan  Society', 'All', 7227936543, '0', '$2y$10$.Jkkywg2A1wxDFoqv2MEGuOsOW3OVzIK7fDErnil6O6XG1hA62dBe', '2022-12-24 23:40:18'),
(55, 'kokila', 'kokila', 'soni', 0, '', '', '', '', 7894561230, '0', '$2y$10$bUiMiYQxJtFGnNVDzgrlh.M51hYYEQtmu4SPgLWx8/X6vqaxmjJEC', '2022-12-25 00:21:20');
...
--
ALTER TABLE `contact`
  MODIFY `contactId` int(21) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `orderitems`
  MODIFY `id` int(21) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=187;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `orderId` int(21) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
...
--
ALTER TABLE `users`
  MODIFY `id` int(21) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT for table `viewcart`
--
ALTER TABLE `viewcart`
  MODIFY `cartItemId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=222;
COMMIT;
