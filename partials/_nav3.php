...
echo '<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:black;max-width:100%;">
      <a class="navbar-brand" href="index.php" style="font-size:1.3rem;margin-top:0px;margin-right:18px;"><b>Modicare</b>Price</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
		  ...
		  <li class="nav-item" style="font-size:1rem;font-weight:bold;">
            <a class="nav-link" href="dp.php">DP Owner</a>
          </li>
          
        </ul>
        <form method="get" action="/DBE/search.php" class="form-inline my-2 my-lg-0 mx-3">
          <input class="form-control mr-sm-2" type="search" name="search" id="search" placeholder="Search Products" aria-label="Search" required autocomplete="off">
